...
ggplot(prevalence_long, aes(x = year, 
  ...
  geom_point(size = 1) +
  labs(title = "COVID-19 Prevalence Over Years",
       x = "Year",
       y = "Prevalence",
       color = "Country") +
  theme_minimal() +
...
datatable(avg_prev, options = list(pageLength = 4))
```

Row
-----------------------------------------
### Case Fatality Rate Trend (2020-2022)

Row
-----------------------------------------
### Average Case Fatality Rate (2020-2022)

Row
-----------------------------------------
### Mortality Rate (2020-2022)

Row
-----------------------------------------
### Average Mortality Rate (2020-2022)
