...
valueBox(
  ...
  caption = 
    paste0(
      ...
      "<br>",
      "<br>",
      "The extracted data was organized into comprehensive dataframe covering all 12 countries. Two versions of the dataframe were used for analysis: (1) the original dataframe and (2) a graded dataframe of the indicators. The graded dataframe consisted of dividing the values of each indicator into quantiles, creating thresholds categorized as \"Very Low\", \"Low\", \"Medium\", \"High\", or \"Very High\" based on their respective indicator values.",
       "<br>",
      "<br>",
